...
class Transformer(nn.Module):
    ...
    def __init__(self, d_model=512, nhead=8, num_encoder_layers=3,
        ...
        self.new_ps = nn.Conv2d(512, 512, (1,1)) # ��������ͼ���������
        self.averagepooling = nn.AdaptiveAvgPool2d(10)
    ...
    def encode_content(self,  mask , content, pos_embed_c):
         # content-aware positional embedding
        # print("content",content.size())   # [B,C,H,W]  [2,512,32,32]
        content_pool = self.averagepooling(content)
        # print("content_pool",content_pool.size())   # [B,C,H,W] [2,512,18,18] # ����Ҫ��Ҫ��ƽ���ػ� �� PatchSize�ĸĶ�
        pos_c = self.new_ps(content_pool) 
        # print("pos_c",pos_c.size())   # [2,512,18,18]
    ...
    def forward(self, style, mask , content, pos_embed_c, pos_embed_s):
        ...
        # print("after encoder style",style.size())
        # print("after encoder content",content.size())
